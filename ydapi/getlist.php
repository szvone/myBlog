...
if (!isset($_SESSION['ck'])) {
  ...
  $url = "https://a1.go2yd.com/Website/channel/news-list-for-channel?channel_id=".$_GET['id']."&fields%5B%5D=title&fields%5B%5D=url&fields%5B%5D=source&fields%5B%5D=date&fields%5B%5D=image&fields%5B%5D=image_urls&fields%5B%5D=comment_count&fields%5B%5D=like&fields%5B%5D=up&fields%5B%5D=down";
...
for ($i=0; $i < sizeof($arr); $i++) { 
  ...
  $out[]=@array("title"=>$arr[$i]->title,"url"=>$arr[$i]->url,"summary"=>$arr[$i]->summary);
}
